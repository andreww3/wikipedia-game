...
var instructions = {
  ...
  pages: [
    ...
    `<div class="narrow-text"><p>Make your guess by clicking on the options below the text. Each time you make a guess, a certain number more words will be revealed. This may reveal a lot more words, or may not reveal any words at all. The new words will be highlighted.</p><p>You must be sure about your choice: in order to correctly guess the article, you will need to click the correct option 3 times in a row.</p><p>Keep guessing until you run out of tries. A status bar below will show how many guesses you have made so far.</p></div>`,
